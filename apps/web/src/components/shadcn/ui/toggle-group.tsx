...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive.Root
      ...
      // eslint-disable-next-line no-restricted-syntax -- spacing is a bounded CSS custom property consumed by the local module.
  ...
  return (
    <ToggleGroupPrimitive.Item
      ...
      className={cn(
        ...
        "w-auto min-w-0 shrink-0 px-3 focus:z-(--sc-z-base) focus-visible:z-(--sc-z-base)",
