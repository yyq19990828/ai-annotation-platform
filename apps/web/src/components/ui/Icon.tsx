...
const iconPaths: Record<string, string> = {
  ...
  settings:
    "M12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6zM19 12l1.7-1-1.5-2.6-1.9.6-.7-.4-.4-2H13l-.4 2-.7.4-1.9-.6-1.5 2.6L10.3 12 10 13l-1.7 1 1.5 2.6 1.9-.6.7.4.4 2H13.2l.4-2 .7-.4 1.9.6 1.5-2.6L16 13z",
