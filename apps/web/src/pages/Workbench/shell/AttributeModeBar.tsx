...
export function AttributeModeBar({
  ...
  return (
    <div
      className="absolute left-1/2 top-3 z-dock-control flex max-w-[min(620px,calc(100%-32px))] -translate-x-1/2 items-center gap-2 rounded-md border border-border bg-card px-2 py-1.5 text-foreground shadow-md"
