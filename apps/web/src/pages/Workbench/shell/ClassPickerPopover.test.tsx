...
describe("ClassPickerPopover", () => {
  it("video scope pointer capture and native activation do not prematurely commit the pending class", async () => {
    const onPick = vi.fn();
    ...
    const { getByRole } = render(
      <>
        <button data-workbench-video-tool-command onClick={onCommand}>
          轨迹范围
        </button>
        <ClassPickerPopover
          position="fixed"
