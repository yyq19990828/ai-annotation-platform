...
import { KonvaBox, KonvaPolygon, KonvaKeypoint, keypointColorByIndex } from "./ImageStageShapes";
...
export function ImageStage({
  ...
  }, [dragging, setVp, toImg, onCommitDrawing, onCommitMove, onCommitResize, onCommitPolygonGeometry, onCommitKeypointGeometry, onCanvasStrokeCommit, canvasStroke, onSamPrompt, maskEditor, imgW, imgH]);
