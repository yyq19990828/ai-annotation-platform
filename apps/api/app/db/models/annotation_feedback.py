...
- anchor_type ∈ {project, task, annotation, pixel} 统一锚点模型.
...
class AnnotationFeedback(Base):
    ...
    # anchor_type ∈ {project, task, annotation, pixel}
    ...
    # pixel anchor: {x: float, y: float, frame?: int}; 坐标语义与 geometry JSONB 一致 (相对坐标 0-1).
