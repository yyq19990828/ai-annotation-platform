            ...
            for ann in ann_by_task.get(t.id, []):
                ...
                ann_entries.append(
                    AAPAnnotationEntry(
                        ...
                        sensor_role=ann.sensor_role,
                        sensor_visibility=ann.sensor_visibility,
                        calibration_revision=ann.calibration_revision,
                        calibration_digest=ann.calibration_digest,
                        user_id=ann.user_id,
