...
顶部“布局”菜单可以调整任务队列、类别面板、标注详情和讨论面板，也可将画布放到整个工作区的左、右、上、下边缘。外围面板可停靠在左侧、右侧或底部，也可拖到另一面板的中央组成标签。拖动分隔条调整停靠区大小；面板标题旁的菜单提供移到左侧、右侧、底部、变为浮窗和隐藏等操作。
...
当前题 AI、视频追踪、3D 三视图、相机面板和选中信息卡仍在各自画布内使用原有浮层，不属于“布局”菜单的四个外围面板。标注详情中的“AI 待审”和“人工”分组保持原有折叠方式，空分组也会显示标题与数量。画布视觉和操作偏好见[工作台设置](./settings)。
