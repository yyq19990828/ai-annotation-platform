...
图片、视频和点云任务使用同一个工作台外壳：画布固定在中心，任务队列、类别面板、标注详情和讨论面板可调整位置；工具栏与状态栏跟随画布，画布内容按任务类型切换。
...
顶部“布局”菜单可以调整任务队列、类别面板、标注详情和讨论面板。画布保持固定，其他面板可停靠在左侧、右侧或底部，也可拖到另一面板的中央组成标签。拖动分隔条调整停靠区大小；面板标题旁的菜单提供移到左侧、右侧、底部、变为浮窗和隐藏等操作。
