...
- **轨迹整体**：关键帧数、帧范围、语义标签 `semantic_label`、轨迹属性，以及拆分轨迹（在当前帧把一条轨迹切成前后两条）、下一预测、AI 传播、复制后续、转换为独立框等轨迹级操作。
...
右键轻点当前帧的轨迹框会在光标处打开同一组常用操作：消失、遮挡、锁定、隐藏、AI 传播、改类、当前帧转独立框、删除当前关键帧和删除整条轨迹。
