...
> Status: approved for implementation. The user requested committing this plan and starting parallel implementation on 2026-09-12.
> Prepared: 2026-09-12.
...
| Paging image project  | Exactly 51 active visible object annotations with stable sort/tie-break values; reuse a small fixture image                                                                                           | Page 1 has 50, page 2 has one; total/facets remain 51; changing filters from page 2 resets correctly                                     |
| Scene LiDAR project   | Two media-backed scene frames and 51 logical track IDs represented in both frames, plus one hidden-batch member to test visibility                                                                    | Two pages of logical tracks, no duplicate track per member/frame; hidden members do not change authorized facet/location results         |
