...
> Status: implementation and behavior acceptance complete; selected documentation-media refresh and resource cleanup are in progress. The user authorized this rollout on 2026-09-12.
> Prepared: 2026-09-12.
...
- Developer documentation: docs-site/dev/reference/filtering.md (new), data-manager-query.md, design-system.md, concepts/workbench-shell.md and reference/testing.md. API behavior is documented in docs-site/api/guides/projects.md and README.md; the route index reflects the guarded test fixture module.
...
- Remaining authorized work: refresh/review the two affected Data Manager screenshots and their existing homepage derivative, finish selected media provenance, remove the last integrated child and recorded disposable runtime resources, and run final integrity/diff checks. Unrelated stale media records remain outside this rollout.
