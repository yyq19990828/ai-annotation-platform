---
roadmap: ROADMAP/[archived]2026-05-12-image-workbench-optimization.md
epic: I11 · Mask 编辑器
version: v0.10.8
status: planned
date: 2026-05-18
...
- `ROADMAP/[archived]2026-05-12-image-workbench-optimization.md` I11 节：把「🚧 v0.10.7.1 / v0.11.0 待补」改为「✅ v0.10.8」；Wave γ 表格 I11 行加「v0.10.8 UI 集成 ✅」。
