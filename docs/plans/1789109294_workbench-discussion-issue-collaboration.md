...
- G3 delivers durable reply/status/annotation-mention notifications with post-commit publication, existing mute/read behavior and validated one-shot discussion navigation. Notification packages landed as `7291b187`, `8bad9b88` and `3d1be350`; this completion commit adds Workbench activation, regression coverage and the final documentation.
