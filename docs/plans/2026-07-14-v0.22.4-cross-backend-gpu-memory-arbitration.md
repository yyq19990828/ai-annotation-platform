...
剩余工作：接通 victim 选择、drain/unload 与其终态对账，不等 60 秒。首个 enforce 子阶段
...
后 lease 的清理顺序完成立即对账。victim 选择、驱逐与 effective enforce 仍未接通。
