...
worker 延迟读取的文件 signer，并保持 off/observe 零私钥访问。active membership、signed legacy ACK、runtime
authority 与 Redis admission/lease 仍未接通。
