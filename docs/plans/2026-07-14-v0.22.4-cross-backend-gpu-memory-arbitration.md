...
P6-II-B 管理面持久状态诊断
与 P6-III demotion 完成前，生产 release latch 仍保持关闭。
...
- [ ] P6-II-B 让管理面展示持久 rollout/effective 真值与精确 blocker。
...
P6-II-A 已让 health worker 在 Backend gate 与 Redis ready 证明后精确提交 enforcing。当前 latch
