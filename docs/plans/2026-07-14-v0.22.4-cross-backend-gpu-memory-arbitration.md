...
P4b-II-C2a 已建立 cold 目标的严格空池证明与 durable generation/horizon 授权原语。cold admission
编排、驱逐与 effective enforce 仍未接通。
