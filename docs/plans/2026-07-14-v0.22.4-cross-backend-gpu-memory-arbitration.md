...
> 版本：v0.22.4 · 状态：P0、P1a、P1b、P1d、P1e、P1f 已完成 · P1c ONNXTools 代码纵切已实现，真实 GPU 回落验证待模型就绪 · P2a/P2b 静态 claim、配置诊断、管理端与 observe 影子派发已完成 · P3a/P3b durable fence 与 Redis 原子账本、P3c-1 Redis 安全重建原语、P3c-2a 持久成员域与令牌时域地基、P3c-2b-I Redis v2 三域演进已完成 · P3c-2b-II/III repair 证明、GC 与 worker、P4–P6 待实施 · 2026-07-15
>
...
P3c-2b-II/III 仍需完成 generation-null Unknown、live health 与 token horizon 证明、partial corruption reset、
...
- [ ] P3c-2b-II 接通 generation-null Unknown、live health/token horizon 证据与 partial corruption proof-backed reset。
...
active-only 新工作、retiring 存量收敛、单调扩域和多卡分片纳入原子账本。可信 bootstrap/reconcile 仍需
P3c-2b-II/III 的 proof-backed reset、live health/token horizon 证据、两阶段 GC、观测与 worker 才能形成
