...
> 版本：v0.22.4 · 状态：P0、P1a、P1b、P1d、P1e、P1f 已完成 · P1c ONNXTools 代码纵切已实现，真实 GPU 回落验证待模型就绪 · P2a/P2b 静态 claim、配置诊断、管理端与 observe 影子派发已完成 · P3a/P3b durable fence 与 Redis 原子账本、P3c-1 Redis 安全重建原语、P3c-2a 持久成员域与令牌时域地基、P3c-2b-I Redis 三域演进、P3c-2b-II-A generation-null Unknown、P3c-2b-II-B challenge-bound proof reset、P3c-2b-III 两阶段 GC 与周期 repair 已完成 · P4a-I 统一派发接缝、P4a-II-A 文件 signer、P4a-II-B1 严格能力证明、P4a-II-B2 legacy ACK、不可逆激活与 post-horizon ready 收敛、P4b-I 显式 HTTP outcome 回报、P4b-II-A legacy mixed-header 防绕过、P4b-II-B1 Redis Resident-only 原子准入门禁、P4b-II-B2a runtime subject、token horizon 与 Resident-only authority、P4b-II-B2b 生产派发注入、P4b-II-B2c 异步失败落档、P4b-II-C0 冷建 owner 门禁、P4b-II-C1 transition wire、P4b-II-C2a cold generation/horizon 地基、P4b-II-C2b-I cold intent、P4b-II-C2b-II-A cold admission authority、P4b-II-C2b-II-B 响应后立即终态对账、P4b-II-C2c-I–IV 空闲 victim 驱逐编排、P5a-I FIFO 原子票据门禁、P5a-II authority 有界两级 FIFO、P5b-I Redis v3 cooldown fence、P5b-II exact card ticket 有界 cooldown 等待、P5c-I-A busy Redis transition CAS、P5c-I-B strict busy proof 与只读 drain 分类、P5c-II-A durable cancel intent、P5c-II-B 被动 RESUME 双证明与 cancel CAS、P5c-III 持久 cancel/unload branch fence、双域有界等待与真实 RESUME、P5c-IV-A device set/验收工具门、P5c-IV-B 本机实物验收、P6-I 持久 rollout 地基、P6-II-A health transition/Redis 提交地基、P6-II-B 管理诊断与 P6-II-C exact reset/mode control intent 已完成，P5c-IV-C 真实第二宿主验收、P6-II-D health gate 顺序与 P6-III demotion/发布收尾待实施 · 2026-07-16
>
...
严格晚于对应 token horizon 的 fresh health。P6-II-D 将把该顺序正式接入 health worker。
...
误关 release latch 或移除静态资源都报 blocker。P6-III demotion 完成前，生产 release latch
仍保持关闭。
...
- [ ] P6-II-D 把 signed reset → enforce gate → Redis ready 顺序接入逐卡 health worker。
- [ ] P6-III 将安全 demotion/legacy ACK 与回滚收敛接入 rollout 状态。
...
reset/mode 的 exact 意图与 post-horizon ACK。health worker 的真实 gate 顺序与 demotion 仍待接入。当前 latch
