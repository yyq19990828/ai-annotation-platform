...
RESUME 签名、strict ACK/health 与 Redis cancel CAS 仍由后续子阶段接线。
...
稳定 pool-id 绑定与 drain health 只读三态分类；P5c-II-A 已补齐 durable cancel intent/generation 与 exact JTI 重放地基；RESUME 证明、authority 双域有界等待
和实物多卡验收仍未开启。
