...
health/setup 数据库观测窗口和 canonical capability SHA-256 把受管能力纳入 challenge proof。active membership、
signed legacy ACK、runtime authority 与 Redis admission/lease 仍未接通。
