...
> 版本：v0.22.4 · 状态：P0 已完成 · P1a 共享 wire 与 P1b YOLO 纵切已实现 · 其余 backend 与仲裁主体待实施 · 2026-07-14
>
...
P1a 已实现共享 wire 与验签契约，P1b 已完成 YOLO 首个受管纵切。Grounded-SAM2、SAM3、ONNXTools、
RapidOCR 的受管 residency / unload 仍待实现，Redis 账本、静态 claim、observe/enforce、驱逐与多卡灰度也未开始。
下一步按同一契约扩展其余 backend；在 P1 全部验收前继续保持平台 enforce 关闭。
