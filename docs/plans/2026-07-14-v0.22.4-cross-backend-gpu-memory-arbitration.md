...
P4b-II-C2b-II-A 已将 cold subject 接入 reservation、token、heartbeat 与 Loading 生产 authority。响应后立即对账、
驱逐与 effective enforce 仍未接通。
