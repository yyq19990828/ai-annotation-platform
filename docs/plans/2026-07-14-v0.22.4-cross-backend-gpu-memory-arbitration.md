...
GPU 数据库路径。P6-I 尚未让 health worker 提交 `enforcing`；P6-II/III 完成前不能开启
release latch。
...
- [ ] P6-II/III 将完整 promotion/Redis ready 提交和安全 demotion/legacy ACK 接入 rollout 状态。
...
当前 latch 默认关闭，worker 尚不能提交 enforcing，因此没有提前改变生产 effective mode。
