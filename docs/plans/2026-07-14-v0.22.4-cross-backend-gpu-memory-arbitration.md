...
> 版本：v0.22.4 · 状态：P0、P1a、P1b、P1d、P1e、P1f 已完成 · P1c ONNXTools 代码纵切已实现，真实 GPU 回落验证待模型就绪 · 仲裁主体 P2–P6 待实施 · 2026-07-15
>
...
Redis 账本、静态 claim、observe/enforce、驱逐与多卡灰度 P2–P6 仍未开始。下一步优先补 ONNXTools
部署验收；如模型仍不就绪，则保持它 non-evictable 并进入 P2 静态 claim/observe，平台 enforce 继续关闭。
