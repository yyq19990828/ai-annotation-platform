...
并以独立超时、固定 ticket TTL 与取消安全清理保证有界等待。busy victim 等待/cancel/cooldown
与实物多卡验收仍未开启。ONNXTools 仍保持 non-evictable，
平台 enforce 继续关闭。
