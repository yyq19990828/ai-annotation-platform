...
| **Supervisely**   | 绩效表、团队热力图、标注速度、通过率、class/tag 统计、空闲剔除和 PDF/Excel 导出;当前已有 Consensus,公开材料中未见 GT/honeypot 闭环。                                                                                      |
