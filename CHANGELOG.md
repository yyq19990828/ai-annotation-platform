...
- AI 工具组文档去掉重复总览图，按智能点、智能框、Magic Box、Exemplar、文本预标顺序展示各自工具条，并补充无侧边栏的真实 SAM3 操作 GIF。
- 文档站 OCR 场景改为真实 RapidOCR 当前题推理 GIF，并同步替换首页首屏与产品实证；工作台录制统一使用 15% 左右侧栏，按场景显式开合且不再写回用户偏好。
