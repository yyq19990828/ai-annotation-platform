...
> 状态：**M0+M1+M2 + v0.9.3 + v0.9.4 phase 1+2+3 已落地**（M0 `01f8d45` / 2026-05-07；M1 v0.9.1 / 2026-05-07；M2 v0.9.2 / 2026-05-07；v0.9.3 phase 1/2/3 / 2026-05-07；v0.9.4 phase 1 / 2026-05-08 `c5eaf94`；v0.9.4 phase 2 Crystal Compass / 2026-05-08；v0.9.4 phase 3 Polished Contour / 2026-05-08），剩余 v0.9.5（M4+M5 合并）`/ai-pre` 文本批量 UI + 运维收口（详见 §4）。后续 v0.10.x 在此基础上**新增**（不替换）SAM 3 backend，详见 [`0.10.x.md`](./0.10.x.md)。
>
...
| **合计剩余** | **~6.5 天 / ~1.3 周**（v0.9.5 M4+M5 合并版） | |
